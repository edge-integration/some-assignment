...
from ev_sa.constants import ITEM_TYPE
from ev_sa.showanswer import ShowAnswerXBlockMixin
from ev_sa.tasks import (
    get_zip_file_name,
    get_zip_file_path,
    zip_student_submissions
)
from ev_sa.utils import (
    get_sha1,
    utcnow,
...
class StaffAssignmentXBlock(StudioEditableXBlockMixin, ShowAnswerXBlockMixin, XBlock):
    """
    This block defines a Staff Graded Assignment.  Students are shown a rubric
    and invited to upload a file which is then graded by staff.
    """
    ...
    def add_xml_to_node(self, node):
        ...
        """
        super(StaffAssignmentXBlock, self).add_xml_to_node(node)
    ...
    def student_view(self, context=None):
        ...
        """
        The primary view of the StaffAssignmentXBlock, shown to students
        ...
        fragment.add_content(
            render_template(
                'templates/staff_assignment/show.html',
                context
            )
        )
        fragment.add_css(_resource("static/css/ev_sa.css"))
        fragment.add_javascript(_resource("static/js/src/ev_sa.js"))
        fragment.add_javascript(_resource("static/js/src/jquery.tablesorter.min.js"))
        fragment.initialize_js('StaffAssignmentXBlock')
        return fragment
    ...
    def studio_view(self, context=None):  # pylint: disable=useless-super-delegation
        ...
        return super(StaffAssignmentXBlock, self).studio_view(context)
