/* Javascript for StaffAssignmentXBlock. */
function StaffAssignmentXBlock(runtime, element) {
    function xblock($, _) {
        ...
        function render(state) {
            ...
            //         var block = $(element).find(".sa-block");
        ...
        function renderStaffGrading(data) {
            ...
            if (data.display_name !== '') {
                $('.sa-block .display_name').html(data.display_name);
            }
        ...
        function isStaff() {
          return $(element).find('.sa-block').attr('data-staff') === 'True';
        }
                      ...
                      $(element).find('.task-message')
                        ...
                        .html(
                          interpolate(
                            ...
                            {support_email: $(element).find('.sa-block').attr("data-support-email")},
                            true
                          )
                        )
